...
<body class="text-gray-800 font-sans">
  ...
  </section>  <!-- About Me -->  <section class="max-w-5xl mx-auto p-6 tilt">
  ...
  </section>  <!-- Skills -->  <section class="max-w-5xl mx-auto p-6 mt-6 tilt">
    <div class="glass p-6 rounded-xl">
  ...
  </section>  <!-- Projects -->  <section class="max-w-5xl mx-auto p-6 mt-6 tilt">
    <div class="glass p-6 rounded-xl">
  ...
  </section>  <!-- Certifications -->  <section class="max-w-5xl mx-auto p-6 mt-6 tilt">
    <div class="glass p-6 rounded-xl">
  ...
  </section>  <!-- Resume -->  <section class="max-w-5xl mx-auto p-6 mt-6 tilt">
  ...
  </section>  <!-- Contact -->  <section class="max-w-5xl mx-auto p-6 mt-10 text-center tilt">
    <div class="glass p-6 rounded-xl">
